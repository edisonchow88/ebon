...
class ControllerModalAccountAdminEditAdmin extends AController {
  	...
  	public function main() {
		...
		//START: set component
			...
			//START: set modal
				$modal['object'] = 'admin';
				$modal['ajax'] = $this->html->getSecureURL('account/ajax_admin');
				...
				//START: set form
					...
					//START: set input [ORDER IS IMPORTANT]
						...
						$input[$i]['type'] = 'select';
						$input[$i]['option'] = $this->model_account_admin->getRole(); 
		...
		//START: set template
			$this->processTemplate('modal/account/admin/edit_admin.tpl' );
		//END
