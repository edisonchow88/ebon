...
class ControllerModalAccountAdminRoleDeleteRole extends AController {
  	...
  	public function main() {
		...
		//START: set component
			...
			//START: set modal
				$modal['object'] = 'role';
				$modal['ajax'] = $this->html->getSecureURL('account/ajax_admin_role');
		...
		//START: set template
			$this->processTemplate('modal/account/admin/role/delete_role.tpl' );
		//END
