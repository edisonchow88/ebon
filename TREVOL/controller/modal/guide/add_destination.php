...
class ControllerModalGuideAddDestination extends AController {
  	...
  	public function main() {
		...
		$modal_input[$i]['tab']['id'] = 'modal-add-destination-tab-main';
		...
		$modal_input[$i]['tab']['id'] = 'modal-add-destination-tab-google';
		$modal_input[$i]['tab']['active'] = false;
		...
		$modal_input[$i]['tab']['id'] = 'modal-add-destination-tab-wiki';
		$modal_input[$i]['tab']['active'] = false;
		...
		$this->processTemplate('modal/guide/add_destination.tpl' );
