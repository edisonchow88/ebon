...
class ControllerModalGuidePoiEditRecognition extends AController {
  	...
  	public function main() {
		...
		//START: Set Input Box [ORDER IS IMPORTANT]
			...
			*/
			...
			$modal_input[$i]['required'] = true;
			$modal_input[$i]['type'] = 'select';
			$modal_input[$i]['option'] = $this->model_resource_data->getDataByDatasetName('recognition'); 
		...
		//START: Set Template
			$this->processTemplate('modal/guide/poi/edit_recognition.tpl' );
		//END
