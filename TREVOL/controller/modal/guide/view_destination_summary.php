...
class ControllerModalGuideViewDestinationSummary extends AController {
  	...
  	public function main() {
		...
		//START: Set Input Box [ORDER IS IMPORTANT]
			...
			*/
			...
			$i = 'section_table';
			$modal_input[$i]['section'] = 'Number of Row';
		...
		//START: Set Template
			$this->processTemplate('modal/guide/view_destination_summary.tpl' );
		//END
