...
class ControllerModalTravelEditDay extends AController {
  	...
  	public function main() {
		...
		$modal_input[$i]['id'] = 'day-id';
		$modal_input[$i]['name'] = 'day_id';
		$modal_input[$i]['type'] = 'hidden';
		$modal_input[$i]['required'] = false;
		$modal_input[$i]['json'] = 'day_id';
		//END: input
		...
		$this->processTemplate('modal/travel/edit_day.tpl' );
