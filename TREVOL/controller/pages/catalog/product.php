...
class ControllerPagesCatalogProduct extends AController {
	...
	public $data = array();
  	...
  	private function _getForm() {
		...
		$this->data['product_hours'] = array();
		$results = $this->model_catalog_product_hour->getProductHours($product_id);
		foreach( $results as $r ) {
            $this->data['product_hours'][ $r['product_hour_id'] ] = $r;
			$this->data['product_hours']['ids'][] = $r['product_hour_id'];
			$this->data['product_hours']['descriptions'][] = $r['description'];
        }
		...
		*/
		...
		/*
		$this->data['form']['fields']['info']['price'] = $form->getFieldHtml(array(
			'type' => 'input',
			'name' => 'price',
		...
		*/
	    ...
	    $this->data['form']['fields']['description']['blurb'] = $form->getFieldHtml(array(
			'type' => 'textarea',
			'name' => 'product_description[blurb]',
			'value' => $this->data['product_description']['blurb'],
			'multilingual' => true,
		));
        $this->data['form']['fields']['description']['description'] = $form->getFieldHtml(array(
			'type' => 'textarea',
