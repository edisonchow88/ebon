...
class ControllerPagesGuideDestinationSubsetGoogle extends AController {
  	...
  	public function main() {
		...
		//START: set data
			$data = $this->model_guide_destination->getDestinationGoogleByDestinationId($destination_id);
		//END
		...
		//START: process data and set result
			if(count($data) > 0 ) {
				foreach($data as $row) {
					...
					$result[$google_id]['destination'] = $destination['name'];
		...
		//START: set modal
			$this->addChild('modal/guide/destination/add_google', 'modal_add_google', 'modal/guide/destination/add_google.tpl');
			$this->addChild('modal/guide/destination/edit_google', 'modal_edit_google', 'modal/guide/destination/edit_google.tpl');
			$this->addChild('modal/guide/destination/delete_google', 'modal_delete_google', 'modal/guide/destination/delete_google.tpl');
		//END
		...
		//START: set template
			$this->processTemplate('pages/guide/destination_subset/google.tpl' );
		//END
