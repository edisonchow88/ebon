...
class ControllerPagesGuideDestinationSubsetImage extends AController {
  	...
  	public function main() {
		...
		//START: set data
			$data = $this->model_guide_destination->getDestinationImageByDestinationId($destination_id);
		//END
		...
		//START: set modal
			$this->addChild('modal/guide/destination/add_image', 'modal_add_image', 'modal/guide/destination/add_image.tpl');
			$this->addChild('modal/guide/destination/edit_image', 'modal_edit_image', 'modal/guide/destination/edit_image.tpl');
			$this->addChild('modal/guide/destination/delete_image', 'modal_delete_image', 'modal/guide/destination/delete_image.tpl');
		//END
		...
		//START: set template
			$this->processTemplate('pages/guide/destination_subset/image.tpl' );
		//END
