...
class ControllerPagesGuidePoiSubsetTag extends AController {
  	...
  	public function main() {
		...
		//START: set data
			$data = $this->model_guide_poi->getPoiTagByPoiId($poi_id);
		//END
		...
		//START: set modal
			$this->addChild('modal/guide/poi/add_tag', 'modal_add_tag', 'modal/guide/poi/add_tag.tpl');
			$this->addChild('modal/guide/poi/edit_tag', 'modal_edit_tag', 'modal/guide/poi/edit_tag.tpl');
			$this->addChild('modal/guide/poi/delete_tag', 'modal_delete_tag', 'modal/guide/poi/delete_tag.tpl');
		//END
		...
		//START: set template
			$this->processTemplate('pages/guide/poi_subset/tag.tpl' );
		//END
