...
class ControllerPagesTagTypePost extends AController {
  	public function main() {
		...
		$redirect = $this->html->getSecureURL('tag/type_list');
	...
	public function add() {
		...
		$tag_type_id = $this->model_tag_tag->addTagType($data); 
	...
	public function edit() {
		...
		$this->model_tag_tag->editTagType($tag_type_id, $data); 
	...
	public function delete() {
		...
		$this->model_tag_tag->deleteTagType($tag_type_id); 
