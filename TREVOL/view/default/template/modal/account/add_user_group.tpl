<!-- START: Modal -->
<div class="modal fade" id="modal-add-user-group" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="modal-add-user-group-form-alert"></div>
                <div id="modal-add-user-group-form-demo" class="text-center"></div>
                <!-- START: Nav tabs -->
                <?php
                    $tab = 0;
                ...
                <form id="modal-add-user-group-form">
                    <input 
                        type="hidden" 
                        name="action"
                        value="add" 
                            ...
                            foreach($modal_input as $i) {
                                if(isset($i['tab'])) {
                                    ...
                                    if($i['type'] == 'textarea') {
                                        ...
                                        echo 'rows="'.$r.'" ';
                                        echo 'id="modal-add-user-group-form-input-'.$i['id'].'" ';
                                        echo 'name="'.$i['name'].'" ';
                                        ...
                                        echo '<span id="modal-add-user-group-form-text-'.$i['id'].'">';
                                        if($i['type'] == 'hidden') {
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" onclick="addUserGroup();">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
	function addUserGroup() {
		var form_element = document.querySelector("#modal-add-user-group-form");
		...
		xmlhttp.onreadystatechange = function() {
			document.getElementById('modal-add-user-group-form-alert').innerHTML = "";
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				if(typeof json.warning != 'undefined') {
					...
					content += "</ul></div>";
					document.getElementById('modal-add-user-group-form-alert').innerHTML = content;
				}
				...
				document.getElementById('modal-add-user-group-form-alert').innerHTML = json.alert;
			}
		};
