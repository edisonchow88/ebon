...
<div class="modal fade" id="modal-delete-google" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h4 class="modal-title">Delete Destination Google</h4>
            </div>
        <div class="modal-body">
            <div class="alert alert-danger" role="alert">
                Are you sure you want to delete <b>Destination Google #<span id="modal-delete-google-form-text-google-id"></span></b> ?
            </div>
