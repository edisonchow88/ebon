...
<div class="modal fade" id="modal-delete-relation" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h4 class="modal-title">Delete Destination Relation</h4>
            </div>
        <div class="modal-body">
            <div class="alert alert-danger" role="alert">
                Are you sure you want to delete <b>Destination Relation #<span id="modal-delete-relation-form-text-relation-id"></span></b> ?
            </div>
...
<script>
	function deleteRelation() {
		...
		var url = "<?php echo $modal_ajax['guide/ajax_destination_relation']; ?>";
		var data = "";
		var query = url + data;
