...
<div class="modal fade" id="modal-delete-wikipedia" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h4 class="modal-title">Delete Poi Wikipedia</h4>
            </div>
        <div class="modal-body">
            <div class="alert alert-danger" role="alert">
                Are you sure you want to delete <b>Poi Wikipedia #<span id="modal-delete-wikipedia-form-text-wikipedia-id"></span></b> ?
            </div>
