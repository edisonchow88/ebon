<!-- START: Modal -->
<div class="modal fade" id="modal-add-mode" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Add Mode</h4>
            </div>
        <div class="modal-body">
        	<div id="modal-form-add-mode-alert"></div>
            <div id="modal-form-add-mode-demo" class="text-center"></div>
            <form id="modal-form-add-mode">
                <input 
                    type="hidden" 
                    name="action"
                    value="add" 
                    	...
                    	if(isset($i['section'])) {
                            ...
                            echo '<div class="input-group col-sm-8 col-xs-12">';
                              if($i['type'] == 'textarea') {
                                ...
                                echo 'rows="5" ';
                                echo 'id="modal-form-add-mode-input-'.$i['id'].'" ';
                                echo 'name="'.$i['name'].'" ';
                                ...
                                echo '<span id="modal-form-add-mode-text-'.$i['id'].'">';
                                if($i['type'] == 'hidden') {
                                    echo $i['text'];
                                }
                                echo '</span>';
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" onclick="addMode();">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
	function addMode() {
		var form_element = document.querySelector("#modal-form-add-mode");
		...
		xmlhttp.onreadystatechange = function() {
			document.getElementById('modal-form-add-mode-alert').innerHTML = "";
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				if(typeof json.warning != 'undefined') {
					...
					content += "</ul></div>";
					document.getElementById('modal-form-add-mode-alert').innerHTML = content;
				}
