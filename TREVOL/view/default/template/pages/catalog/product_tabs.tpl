<ul class="nav nav-tabs nav-justified nav-profile">
	<li <?php echo ( $active == 'general' ? 'class="active"' : '' ) ?>><a href="<?php echo $link_general; ?>"><span><?php echo $tab_general; ?></span></a></li>
    <li <?php echo ( $active == 'info' ? 'class="active"' : '' ) ?>><a href="<?php echo $link_info; ?>"><span><?php echo $tab_info; ?></span></a></li>
