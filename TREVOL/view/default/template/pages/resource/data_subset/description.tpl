...
<div id="content" class="panel panel-default">
	<div class="panel-heading col-xs-12">
        ...
        <div class="col-xs-3 text-right"><a data-toggle="modal" data-target="#modal-add-description" class="btn btn-danger" role="button">Add Description</a></div>
	</div>
...
<script>
	var grid = $("#grid").bootgrid({
		...
		formatters: {
			...
			{
				str = "<span id='description-status-"+row.id+"' class='btn command-toggle-description-status' data-row-id='"+row.id+"'>";
				if(row.row_status == 1) {
				...
				+ "<nav style='display:inline !important; margin-left:10px !important;'>"
					+ "<ul class='pagination' style='margin: 0px !important;'>"
						+ "<li>"
							...
							+ "<a class='btn btn-sm command-edit' data-toggle='modal' data-target='#modal-edit-description' data-row-id='"+row.id+"'>"
						...
						+ "<li>"
							...
							+ "<a class='btn btn-sm command-delete' data-toggle='modal' data-target='#modal-delete-description' data-row-id='"+row.id+"'>"
