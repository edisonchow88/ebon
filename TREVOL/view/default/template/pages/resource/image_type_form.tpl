...
<div id="content" class="panel panel-default">
	...
	<div class="panel-heading col-xs-12">
    	<div class="col-xs-2 text-left"><a href="<?php echo $link['resource/image_type_list'];?>" class="btn btn-default" role="button">Cancel</a></div>
	...
	<div class="panel-body panel-body-nopadding tab-content col-xs-12">
    	<form id="form-main" role="form" style="max-width:600px; margin:auto;" action="<?php echo $link['resource/image_type_post'];?>" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-group col-sm-9 col-xs-12">
                	<input 
                    	type="hidden" 
                        id="input-image-type-id" 
                        name="image_type_id"
                        value="<?php echo $form['image_type_id']; ?>"
                    >
                    <?php echo $form['image_type_id']; ?>
                </div>
            </div>
            <div class="form-group">
             ...
             <div class="form-group">
            	<label class="control-label col-sm-3 col-xs-12" for="input-type">Description</label>
                <div class="input-group col-sm-9 col-xs-12">
                	<textarea
                        class="form-control" 
             ...
             <div class="form-group">
            	<label class="control-label col-sm-3 col-xs-12" for="input-type">Link</label>
                <div class="input-group col-sm-9 col-xs-12">
                	<input 
                        type="url" 
                        class="form-control" 
    ...
    <div class="panel-footer col-xs-12">
    	<div class="col-xs-6 text-right"><a href="<?php echo $link['resource/image_type_list'];?>" class="btn btn-default" role="button">Cancel</a></div>
