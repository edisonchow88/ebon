						...
						<div class="quantitybox">
							<?php if ($display_price) { ?>
								...
								<fieldset>
                                    ...
                                    <div>
                                    	<a class="btn" href="<?php echo $add; ?>"><i class="fa fa-plus-circle fa-fw fa-2x"></i>Add to Trip</a>
                                    </div>
                                    ...
                                    <?php 
										if ($in_itinerarylist) { 
											$idinerarylist = ' style="display: none;" ';
											$noidinerarylist = '';
										} else {
											$noidinerarylist = ' style="display: none;" ';
											$idinerarylist = '';
										} 
									?>
                                    <div class="itinerarylist">
										<a class="itinerarylist_remove btn btn-large" href="#" onclick="itinerarylist_remove(); return false;" <?php echo $noidinerarylist; ?>>
											<i class="fa fa-trash-o"></i> <?php echo $button_remove_itinerarylist; ?>
										</a>
										<a class="itinerarylist_add btn btn-large" href="#" onclick="itinerarylist_add(); return false;" <?php echo $idinerarylist; ?>>
											<i class="fa fa-plus-square"></i> <?php echo $button_add_itinerarylist; ?>
										</a>
									</div>
                                    -->
								</fieldset>
