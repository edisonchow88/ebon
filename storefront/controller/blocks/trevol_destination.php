...
class ControllerBlocksTrevolDestination extends AController {
	public $data = array();
	...
	public function main() {
    	...
    	$this->view->assign('heading_title', 'Destination' );
		...
		$this->data['image_width'] = (int)$this->config->get('config_image_category_width').'px';
		$this->view->batchAssign( $this->data );
		
		$this->view->assign('home_href', $this->html->getSEOURL('index/home'));
		$parent_id = 3; //parent_id is set for testing purpose
		$this->view->assign('categories', $this->_buildNestedCategoryList($parent_id));
