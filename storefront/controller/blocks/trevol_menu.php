...
class ControllerBlocksTrevolMenu extends AController {
	public $data = array();
	...
	public function main() {
		...
		//ADDED by TREVOL, 2016/01/18
		$this->view->assign('destination',  $this->html->getSEOURL(''));
		$this->view->assign('itinerary', $this->html->getSEOURL('itinerary/list'));
		$this->view->assign('trip', $this->html->getSEOURL('trip/list'));
