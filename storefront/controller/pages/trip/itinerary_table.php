...
class ControllerPagesTripItineraryTable extends AController {
	...
	public function main() {
		...
		//START: set column
			...
			$column[$i]['class'] = 'col-'.str_replace("_","-",$i);
			...
			$column[$i]['dayClass'] = 'col-'.str_replace("_","-",$j);
			$j = 'time';
			$column[$i]['lineName'] = $j;
			$column[$i]['lineId'] = str_replace("_","-",$j);
			$column[$i]['lineClass'] = 'col-'.str_replace("_","-",$j);
			$column[$i]['width'] = '110px';
			$column[$i]['align'] = '';
			$column[$i]['headerAlign'] = '';
			$column[$i]['visible'] = 'true';
			...
			$column[$i]['class'] = 'col-'.str_replace("_","-",$i);
			$column[$i]['title'] = ucwords(str_replace("_"," ",$i));
			$column[$i]['headerStyle'] = 'padding-left:20px;';
			$column[$i]['dayStyle'] = 'padding-left:20px;';
			$column[$i]['lineStyle'] = 'padding-left:20px;';
			$column[$i]['width'] = '';
			$column[$i]['align'] = '';
			$column[$i]['headerAlign'] = '';
			$column[$i]['visible'] = 'true';
