...
<!-- START: Modal -->
    <div class="modal modal-fixed-top" id="modal-trip-share" role="dialog" data-backdrop="false">
        <div class="modal-wrapper">
            <div class="modal-header">
                <div id="modal-trip-share-header-general" class="header fixed-bar fixed-width">
                    <div class="col-xs-3 text-left">
                        <a class="btn btn-header" data-toggle="modal" data-target="#modal-trip-share">Cancel</a>
                    </div>
                    <div class="col-xs-6 text-center">
                        <div class="title">Share Trip</div>
                    </div>
